...
description: "Get cost tracking for your Anthropic calls in under 2 minutes."
---
...
const anthropic = new Anthropic({
  baseURL: "https://proxy.nullspend.com",
  defaultHeaders: {
...
client = Anthropic(
    base_url="https://proxy.nullspend.com",
    default_headers={
...
```bash
curl https://proxy.nullspend.com/v1/messages \
