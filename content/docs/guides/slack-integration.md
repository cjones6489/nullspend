...
description: "Get real-time NullSpend alerts in Slack — budget thresholds, HITL approvals, and margin warnings."
---
...
Custom thresholds can be set per-budget via the API — see [Budgets API](/docs/api-reference/budgets-api).
...
- [Budgets](/docs/features/budgets) — how budget limits and thresholds work
- [Human-in-the-Loop](/docs/features/human-in-the-loop) — action lifecycle and approval flow
- [Margins](/docs/features/margins) — Stripe margin tracking
- [Webhooks Overview](/docs/webhooks/overview) — HTTP webhook alternative for programmatic integrations
