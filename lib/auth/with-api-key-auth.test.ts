...
describe("authenticateApiKey", () => {
  ...
  it("returns ApiKeyAuthContext with rateLimit for managed key identity", async () => {
    ...
    mockedAssertApiKey.mockResolvedValue({ userId: "user-123", keyId: "key-456", apiVersion: "2026-04-01" });
  ...
  it("returns ApiKeyAuthContext for dev fallback (keyId: null)", async () => {
    ...
    expect(result).toEqual({ userId: "dev-user", keyId: null, apiVersion: "2026-04-01" });
