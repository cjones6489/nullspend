...
Manage mappings between Stripe customers and NullSpend cost attribution tags. These mappings power the [Margins](../features/margins.md) feature by linking Stripe revenue to NullSpend cost data.
...
- [Margins](../features/margins.md) — margin tracking overview
- [Margins API](margins-api.md) — margin data and unmatched customers
- [Cost Attribution](../features/cost-attribution.md) — how tags drive attribution
